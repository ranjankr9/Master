...
$(document).ready(function(){
	...
	//TODO : Search behaviour is not correct for Baidu Map, only supports china cities address 
	//Tested data : {Haidian District, Beijing 10th Street, Beijing}
	//Haidian District, Beijing 10th Street => Location found : 117.569874 : 34.856745
	//Beijing = > Location found : 117.569874 : 34.856745
	 ...
	 $(".search-container").submit(function(e){
	        ...
	        if(searchLocBaiduMarker) {
		        ...
		        if (val) {
		        	console.log('Search requested for location : ' + val);
